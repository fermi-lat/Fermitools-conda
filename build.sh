...
if [ -d "lib/debianstretch/sid-x86_64-64bit-gcc76-Optimized" ]; then
    echo "Subdirectory Found! (Lib)"
    pwd
    ls lib/
    ls lib/debianstretch/
    ls lib/debianstretch/sid-x86_64-64bit-gcc76-Optimized/
...
if [ -d "include/debianstretch/sid-x86_64-64bit-gcc76-Optimized" ]; then
...
if [ -d "exe/debianstretch/sid-x86_64-64bit-gcc76-Optimized" ]; then
