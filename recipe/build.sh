...
if [ "$(uname)" == "Darwin" ]; then
    ...
    export CXXFLAGS="-mmacosx-version-min=${MACOSX_DEPLOYMENT_TARGET} -stdlib=libc++ ${CXXFLAGS} -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1/"
